...
int main() {
  ...
  "header and payload"_test = [] {
    ...
    std::vector<std::uint8_t> buffer{
      ...
      1, 0, 0, 0,  // serial
      61, 0, 0, 0,  // field array byte length
      // [0]
      6,  // code destination
      ...
      5,  // code reply_serial
      1,  // signature length
      'u', 0,  // signature + null terminator
      1, 0, 0, 0,  // reply serial 1
      // [2]
      8,  // code signature of the message body
      1,  // the following signature length of variant
      'g', 0,    // signature of signature + null terminator
      1,    // length of signature
      's',  // body signature of the message, string
      0, 0,  // padding
      // [3]
      7,  // code sender
      1,  // signature length
      's', 0, // signature + null terminator
      20, 0, 0, 0, // string length 20 bytes
      'o', 'r', 'g', '.', 'f', 'r', 'e', 'e', 'd', 'e', 's', 'k', 't', 'o', 'p', '.', 'D', 'B', 'u', 's', 0, // string content + null terminator
      0, 0, 0, // padding
      // beginning of body
      5, 0, 0, 0, // string length 5 bytes
      ':', '1', '.', '9', '7', 0, // string
...
// wat is this
      'l', // endian
      4, // message type signal emission
      1,
      1,
      10,
      0,
